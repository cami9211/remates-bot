...
(el listado solo muestra un resumen truncado). Esta es la fuente que
aporta el grueso de los resultados.
...
categoría propia sea "REMATES". Por su naturaleza (depende de qué tan
lejos llegue la cadena de enlaces desde las semillas) esta fuente aporta
pocos resultados por sí sola; se mantiene como complemento de El
Colombiano, no como fuente principal. NOTA: este rastreo depende de que
el sitio siga mostrando ese bloque de enlaces con la misma estructura;
si Asuntos Legales cambia el diseño de la página, el patrón de
extracción (AL_BLOQUE_RE más abajo) puede necesitar ajuste.
                ...
                <tr>
                  <td style="background:#1e3a5f; border-radius:12px 12px 0 0; padding:22px 26px;">
                    ...
                    <div style="font-size:13px; color:#c9d6e5; margin-top:4px;">
                      Clasificados Judiciales — El Colombiano y Asuntos Legales · {hoy} · {len(edictos)} de hasta {MAX_RESULTADOS} resultado(s)
                    </div>
                  </td>
                </tr>
